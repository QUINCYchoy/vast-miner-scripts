...
SRB_URL="https://github.com/doktor83/SRBMiner-Multi/releases/download/3.6.8/SRBMiner-Multi-3-6-8-Linux.tar.gz"
SRB_ARCHIVE="$BASE_DIR/SRBMiner-Multi-3-6-8-Linux.tar.gz"
SRB_DIR="$BASE_DIR/SRBMiner-Multi-3-6-8"
