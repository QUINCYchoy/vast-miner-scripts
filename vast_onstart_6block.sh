...
EXPECTED_MIN_RATIO="${EXPECTED_MIN_RATIO:-0.80}"

echo "EXPECTED_MIN_RATIO: $EXPECTED_MIN_RATIO" >> "$LOG_SETUP"
...
SRB_URL="https://github.com/doktor83/SRBMiner-Multi/releases/download/3.6.2/SRBMiner-Multi-3-6-2-Linux.tar.gz"
SRB_ARCHIVE="$BASE_DIR/SRBMiner-Multi-3-6-2-Linux.tar.gz"
SRB_DIR="$BASE_DIR/SRBMiner-Multi-3-6-2"
